...
<div class="bgded overlay" style="background-image:url('images/Add-Read-the-grammar-book-every-morning_1920x1080-2.jpg');">
    ...
    <div id="pageintro" class="hoc clear">
        ...
        <article class="clear">
            ...
            <h2 class="heading">Orient New Teacher Registration </h2>
    ...
    <div class="hoc container clear">
        ...
        <div class="center btmspace-50">
            ...
            <ul class="nospace group btmspace-50 elements">
                ...
                <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////-->
                <form id="formTeacher">
                    <input type="text" class="form-control" id="txtTID" name="txtTID" onkeypress="return tSearchKeyPress(event);">
                    <br><br>
                    <table class="tb1">
                        <tr>
                            <td> Teacher Name</td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="school" id="txtSCL"></td>
                        </tr>
                    ...
                    <br><br>
                    <button class="button button2" id="updateTBtn" style="margin-left: 20cm" type="button">Update Teacher</button>
                    <button class="button button2" id="cancelBtn" style="margin-left: 20cm" type="button">Cancel Registration</button>
                </form>


            </ul>
            <p class="nospace center"><a class="btn" href="main.html">Go To Back Page </a></p>
                ...
                <div class="one_third">
                    ...
                    <ul class="nospace linklist contact">
                        <li><i class="fa fa-map-marker"></i>
                            <address>
                                Street Name Udawththa Rd; 256/5, Horana, 12300/Zip
                            </address>
                        </li>
                        <li><i class="fa fa-phone"></i> +00 (123) 456 7890</li>
                        <li><i class="fa fa-fax"></i> +00 (123) 456 7890</li>
                        <li><i class="fa fa-envelope-o"></i> orient.com</li>
                    </ul>
                </div>
                <div class="one_third">
