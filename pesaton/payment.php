...
<div class="bgded overlay" style="background-image:url('images/Add-Read-the-grammar-book-every-morning_1920x1080-2.jpg');">
    ...
    <div id="pageintro" class="hoc clear">
        ...
        <article class="clear">
            ...
            <h2 class="heading">Orient Student Payment Form </h2>
        ...
        <div class="center btmspace-50">
            ...
            <ul class="nospace group btmspace-50 elements">
                ...
                <form id="payment-form">
                    ...
                    <tr>
                        <td>Batch</td>
                        <td> <select class="form-control is-valid" name="batch" required >
                                <?php
                    ...
                    <tr>
                        <td>Subject</td>
                        <td> <select class="form-control is-valid" name="subject" required >
                                <?php
                    ...
                    <tr>
                        <td>Month</td>
                        <td><select class="form-control is-valid" name="month" required >
                ...
                <div class="scrollable">
                    <table id="tblpayment">
                        ...
                        <tbody>
                        <?php
                        $resultSet = mysqli_query($connection, "select * from Payment");
                        $result = mysqli_fetch_all($resultSet);
                    ...
                    <br><br><button class="btn btn-danger" id="paymentBtn" style="margin-left: 20cm;background-color: lawngreen" type="button" >Saving Payment</button>
                    <br><br><button class="btn btn-danger" id="cancelBtn" style="margin-left: 20cm;background-color: red" type="button" >Cancel Payment</button>
                </div>
